...
bar = [
    go.Mesh3d(x=[1.8,2.3,2.3,1.8,1.8],y=[1.5,1.5,2.5,2.5,1.5],z=[0.7,0.7,0.7,0.7,0.7], color='yellow', opacity=0.7),
    go.Mesh3d(x=[1.8,2.3,2.3,1.8,1.8],y=[1.5,1.5,2.5,2.5,1.5],z=[0.7,0.7,0,0,0.7], color='yellow', opacity=0.7),
]
